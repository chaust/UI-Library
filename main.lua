...
do
	...
	function utility:GenerateName()
		...
		for i = 1, math.random(14, 24) do
			...
			name = name .. (math.random(0, 1) == 1 and string.lower(character) or character)
		end
		return name
	end
	...
	function utility:DraggingEnabled(frame, parent)
		...
		UserInputService.InputChanged:Connect(function(input)
			if input == dragInput and dragging then
				...
				local renderWait = RunService.RenderStepped:Wait()
				parent:TweenPosition(UDim2.new(framePos.X.Scale, framePos.X.Offset + delta.X, framePos.Y.Scale, framePos.Y.Offset + delta.Y), Enum.EasingDirection.Out, Enum.EasingStyle.Linear, renderWait, true)
			end
		end)
	...
	function section:addColorPicker(title, default, callback)
		...
		color.MouseButton1Down:Connect(function()
			...
			while draggingColor do
				...
				hue = 1 - math.clamp(1 - ((mouse.X - color.AbsolutePosition.X) / color.AbsoluteSize.X), 0, 1)
				color3 = Color3.fromHSV(hue, sat, brightness)
